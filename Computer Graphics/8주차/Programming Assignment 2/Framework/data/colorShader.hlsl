...
// Brightness buffer for pixel shader (register b1)
cbuffer BrightnessBuffer : register(b1)
{
    float brightness;
    float3 padding;
};
...
// Pixel Shader
// The pixel shader draws each pixel on the polygons that will be rendered to the
